...
#SBATCH --error myJob_frustum_pointnet_nuscenes_htc_mask_one_hot.err
#SBATCH --output myJob_frustum_pointnet_nuscenes_htc_mask_one_hot.out
#SBATCH --gres=gpu:8
#SBATCH --nodes 1
...
python -m torch.distributed.launch \
	...
	--launcher pytorch \
	--work-dir="/mnt/proj2/dd-24-8/mmdetection_work_dir/frustum_pointnet_nuscenes_htc_mask_one_hot"