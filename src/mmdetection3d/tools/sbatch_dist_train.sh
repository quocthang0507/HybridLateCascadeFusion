...
#SBATCH --error myJob_frustum_pointnet_nuscenes_htc_mask.err
#SBATCH --output myJob_frustum_pointnet_nuscenes_htc_mask.out
#SBATCH --gres=gpu:8
#SBATCH --nodes 1
...
python -m torch.distributed.launch \
	...
	--nproc_per_node=8 \
	$HOME/3d_object_detection/src/mmdetection3d/tools/train.py \
	$HOME/3d_object_detection/src/mmdetection3d/configs/frustum_localizer/frustum_pointnet_nuscenes_htc_mask.py \
	--launcher pytorch \
	--work-dir="/mnt/proj2/dd-24-8/mmdetection_work_dir/frustum_pointnet_nuscenes_htc_mask"