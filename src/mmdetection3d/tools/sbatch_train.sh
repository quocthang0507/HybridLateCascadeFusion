...
#SBATCH --error myJob_frustum_pointnet_nuscenes_mask_rcnn_6_rot_s.err
#SBATCH --output myJob_frustum_pointnet_nuscenes_mask_rcnn_6_rot_s.out
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
...
CUDA_VISIBLE_DEVICES=0 python $HOME/3d_object_detection/src/mmdetection3d/tools/train.py \
	...
	--work-dir="/mnt/proj2/dd-24-8/mmdetection_work_dir/frustum_pointnet_nuscenes_mask_rcnn_6_rot_single_gpu"
