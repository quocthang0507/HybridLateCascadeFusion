...
data_root = '/mnt/proj2/dd-24-8/frustum_datasets/nuscenes_mask_rcnn_many_points/'
class_names = [
...
model = dict(
    ...
    seg_decode_head=dict(
        type='PointNet2Head',
        fp_channels=((1674, 128, 128), (448, 128, 128), (128, 128, 128)),
        channels=128,
    ...
    anchors=[
        ...
        [6.38352896, 2.73050468, 3.13312415], # construction_vehicle
    ...
    rotations=[-3.14, -2.09, -1.04, 0, 1.05, 2.10],
    ...
    gamma_corner=0.1,
    corner_loss=True,
    train_cfg=dict(sample_seg_points=512),
    test_cfg=dict(sample_seg_points=512),)
...
val_evaluator = dict(
    ...
    with_cls_out=False,
    classes=class_names,
    iou_thresholds=[0.7, 0.7, 0.7, 0.7, 0.7, 0.5, 0.5, 0.5, 0.5, 0.5])
