...
data_root = '/mnt/proj2/dd-24-8/frustum_datasets/nuscenes_v3_all_classes/'
class_names = [
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        ann_file='/mnt/proj2/dd-24-8/frustum_datasets/nuscenes_v2_all_classes/nusc_frustum_info_val.pkl',
