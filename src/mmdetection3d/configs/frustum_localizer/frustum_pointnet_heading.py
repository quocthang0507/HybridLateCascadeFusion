...
model = dict(
    ...
    seg_decode_head=dict(
        type='PointNet2Head',
        fp_channels=((1668, 128, 128), (448, 128, 128), (128, 128, 128)),
        channels=128,
...
train_pipeline = [
    ...
    dict(
        ...
        meta_keys=('img_path', 'ori_shape', 'img_shape', 'lidar2img',
                   ...
                   'axis_align_matrix', 'one_hot_vector', 'frustum_angle'))
]
test_pipeline = [
    dict(
        type='LoadPointsFromDict',
