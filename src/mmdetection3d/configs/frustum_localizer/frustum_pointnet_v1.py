...
model = dict(
    type='FrustumPointNetV1',
    data_preprocessor=dict(type='Det3DDataPreprocessor'),
    in_channels=4,
    encoder1_channels=[64, 64],
    encoder2_channels=[64, 128, 1024],
    seg_decoder_channels=[512, 256, 128, 128, 2],
    bbox_channels=[128, 128, 256, 512],
    final_fc_channels=[512, 256],
    with_one_hot=True,
    one_hot_len=3,
    anchors=[
        [0.8, 0.6, 1.73], 
