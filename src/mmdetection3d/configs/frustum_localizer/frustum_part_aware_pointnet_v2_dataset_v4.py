...
model = dict(
    type='FrustumPartAwarePointNetV2',
    data_preprocessor=dict(type='Det3DDataPreprocessor'),
    seg_backbone=dict(
        type='PointNet2SAMSG', #'FrustumPointNetBackbone',
        in_channels=6,  # [xyzrl1l2]
...
train_pipeline = [
    ...
    dict(
        ...
        meta_keys=('img_path', 'ori_shape', 'img_shape', 'lidar2img',
                   ...
                   'cam_to_img', 'cam_to_lidar', 'frustum_angle', 'gt_bboxes_left'))
]
test_pipeline = [
    dict(
        type='LoadPointsFromDict',
