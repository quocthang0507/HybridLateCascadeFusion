...
data_root = '/mnt/proj2/dd-24-8/frustum_datasets/nuscenes_v1/'
class_names = ['car', 'truck', 'bus', 'bicycle', 'motorcycle', 'pedestrian']
...
model = dict(
    ...
    seg_decode_head=dict(
        type='PointNet2Head',
        fp_channels=((1670, 128, 128), (448, 128, 128), (128, 128, 128)),
        channels=128,
    ...
    gamma_corner=0.1,
    corner_loss=True,
    train_cfg=dict(sample_seg_points=128),
    test_cfg=dict(sample_seg_points=128),)

train_pipeline = [
    dict(
        type='LoadPointsFromDict',
        coord_type='LIDAR',
        load_dim=4,  # x, y, z, time
        use_dim=4,
    ...
    dict(type='PointsRangeFilter', point_cloud_range=[-1000, -1000, -1000, 1000, 1000, 1000]),
    dict(type='ObjectRangeFilter', point_cloud_range=[-1000, -1000, -1000, 1000, 1000, 1000]),
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                type='PointsRangeFilter', point_cloud_range=[-1000, -1000, -1000, 1000, 1000, 1000])
        ]),
    # dict(type='PointSample', num_points=512, replace=False),
    dict(
        type='Pack3DDetInputs',
...
val_evaluator = dict(
    ...
    with_cls_out=False,
    classes=class_names,
    iou_thresholds=[0.7, 0.7, 0.7, 0.5, 0.5, 0.5])
