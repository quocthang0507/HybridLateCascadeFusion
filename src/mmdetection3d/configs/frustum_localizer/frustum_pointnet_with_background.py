...
data_root = '/mnt/proj2/dd-24-8/frustum_datasets/v1_bg/'
class_names = ['Pedestrian', 'Cyclist', 'Car', 'Background']
input_modality = dict(use_lidar=True, use_camera=False)
metainfo = dict(classes=class_names)
backend_args = None

model = dict(
    type='FrustumPointNetWithScore',
